...
const pl: Dictionary = {
  ...
  "top.home": "Strona główna", "top.private": "tryb prywatny", "theme.choose": "Wybierz motyw", "theme.label": "Motyw", "theme.appearance": "Wygląd",
  ...
  "peer.online": "Online", "peer.verified": "Kontakt zweryfikowany", "peer.compare": "Porównaj kod", "peer.demoDescription": "Lokalna makieta: możesz testować motywy i elementy sterujące.", "peer.directDescription": "Wiadomości biegną bezpośrednio między przeglądarkami.",
...
const ru: Dictionary = {
  ...
  "top.home": "На главную", "top.private": "приватный режим", "theme.choose": "Выбрать тему", "theme.label": "Тема", "theme.appearance": "Оформление",
  ...
  "peer.online": "В сети", "peer.verified": "Контакт проверен", "peer.compare": "Сверить код", "peer.demoDescription": "Локальный макет: можно проверять темы и элементы управления.", "peer.directDescription": "Сообщения идут напрямую между браузерами.",
...
const uk: Dictionary = {
  ...
  "top.home": "На головну", "top.private": "приватний режим", "theme.choose": "Вибрати тему", "theme.label": "Тема", "theme.appearance": "Оформлення",
  ...
  "peer.online": "Онлайн", "peer.verified": "Контакт перевірено", "peer.compare": "Звірити код", "peer.demoDescription": "Локальний макет: можна перевіряти теми та елементи керування.", "peer.directDescription": "Повідомлення йдуть напряму між браузерами.",
