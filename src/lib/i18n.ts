...
const pl: Dictionary = {
  ...
  "top.home": "Strona główna", "top.private": "tryb prywatny", "theme.choose": "Wybierz motyw", "theme.label": "Motyw", "theme.appearance": "Wygląd", "sound.enable": "Włącz dźwięki", "sound.disable": "Wycisz dźwięki", "sound.on": "Dźwięki włączone", "sound.off": "Dźwięki wyłączone",
  "state.connectingSignaling": "Łączenie z pokojem", "state.waitingPeer": "Czekamy na rozmówcę", "state.connectingPeer": "Tworzenie kanału bezpośredniego", "state.authenticating": "Sprawdzanie kluczy", "state.secure": "Bezpieczny kanał", "state.closed": "Połączenie zamknięte",
  ...
  "peer.online": "Online", "peer.offline": "Offline", "peer.verified": "Kontakt zweryfikowany", "peer.compare": "Porównaj kod", "peer.demoDescription": "Lokalna makieta: możesz testować motywy i elementy sterujące.", "peer.directDescription": "Wiadomości biegną bezpośrednio między przeglądarkami.",
...
const ru: Dictionary = {
  ...
  "top.home": "На главную", "top.private": "приватный режим", "theme.choose": "Выбрать тему", "theme.label": "Тема", "theme.appearance": "Оформление", "sound.enable": "Включить звуки", "sound.disable": "Выключить звуки", "sound.on": "Звуки включены", "sound.off": "Звуки выключены",
  "state.connectingSignaling": "Подключаемся к комнате", "state.waitingPeer": "Ждём собеседника", "state.connectingPeer": "Строим прямой канал", "state.authenticating": "Проверяем ключи", "state.secure": "Защищённый канал", "state.closed": "Соединение закрыто",
  ...
  "peer.online": "В сети", "peer.offline": "Не в сети", "peer.verified": "Контакт проверен", "peer.compare": "Сверить код", "peer.demoDescription": "Локальный макет: можно проверять темы и элементы управления.", "peer.directDescription": "Сообщения идут напрямую между браузерами.",
...
const uk: Dictionary = {
  ...
  "top.home": "На головну", "top.private": "приватний режим", "theme.choose": "Вибрати тему", "theme.label": "Тема", "theme.appearance": "Оформлення", "sound.enable": "Увімкнути звуки", "sound.disable": "Вимкнути звуки", "sound.on": "Звуки ввімкнено", "sound.off": "Звуки вимкнено",
  "state.connectingSignaling": "Підключення до кімнати", "state.waitingPeer": "Чекаємо на співрозмовника", "state.connectingPeer": "Створення прямого каналу", "state.authenticating": "Перевірка ключів", "state.secure": "Захищений канал", "state.closed": "З'єднання закрито",
  ...
  "peer.online": "Онлайн", "peer.offline": "Офлайн", "peer.verified": "Контакт перевірено", "peer.compare": "Звірити код", "peer.demoDescription": "Локальний макет: можна перевіряти теми та елементи керування.", "peer.directDescription": "Повідомлення йдуть напряму між браузерами.",
